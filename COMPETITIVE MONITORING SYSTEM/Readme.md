...
- `data/product.csv`: Dữ liệu đầu vào (đóng vai trò như tín hiệu cảm biến thu thập từ sàn thương mại điện tử).
...
- `requirements.txt`: Danh sách các thư viện phụ thuộc cần thiết để vận hành hệ thống.
...
```bash
git clone [https://github.com/ivancoder07/bibica-market-intelligence.git](https://github.com/ivancoder07/bibica-market-intelligence.git)
